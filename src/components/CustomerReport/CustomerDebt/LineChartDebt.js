...
class LineChartDebt extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    getData(txtDepot = null, txtDateF = null, txtDateT = null) {
        ...
        const { depot, datef, datet } = this.state;
        const params = {
            mtype: 'DebtChart',
            chart_by: 2,
    ...
    render() {
        const { dataDepot1, datef, datet, refreshing } = this.state;
...
export default connect(mapStateToProps)(LineChartDebt);